...
public class Ex {
	...
	public static boolean isExecutable(ExcelUtil xlsfile, String sheet,String testName) {
		try {
	...
	public static void checkRunMode(String sheetName, String testName,String file) {
		ExcelUtil xls = new ExcelUtil(file, sheetName);

		if (!Ex.isExecutable(xls, sheetName, testName))
	...
	public static Object[][] getData(String file ,String sheetName, String testName,String testMode) {
		...
		ExcelUtil xlsData = new ExcelUtil(file, sheetName);
		Object[][] data = null;
